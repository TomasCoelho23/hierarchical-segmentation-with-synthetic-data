...
def main(cfg : DictConfig):
    ...
    train_dataset = PhenoBenchPlantCrops(cfg.data.root, "train", processor, "small_instances_thesh_2500_2.txt", target_type=cfg.data.target_type, size=cfg.data.img_size, transform=get_transforms_small_plants(cfg, True), blackout=cfg.data.blackout, overfit=cfg.overfit)
    ...
    # 2. Dataloaders
    train_dataloader = DataLoader(train_dataset, batch_size=cfg.training.batch_size, shuffle=False, collate_fn=collate_fn, num_workers=cfg.data.num_workers)
